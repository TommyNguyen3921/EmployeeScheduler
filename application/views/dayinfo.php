            ...
            $modtimes = explode(",", $modtime);
             ...
             { ?>
                ...
                <td><?php if ($gscheduleinfoIDs[$i] != "") { ?>
                    <a class="btn btn-danger" href="<?= base_url() ?>index.php?/Setupschedule/deleteshift/<?= $gscheduleinfoIDs[$i]  ?>/<?= $weekID  ?>/<?= $day  ?>">X</a><?php } ?></td>
...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        //allow employee table to be selectable

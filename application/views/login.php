			...
			<form method="POST" action="<?php echo base_url(); ?>index.php/User/login">
				<fieldset>
					<div class="form-group">
						<input class="form-control" placeholder="Email" name="email" value="curly" required>
					</div>
					<div class="form-group">
						<input class="form-control" placeholder="Password" type="password" name="password" value="test123" required>
					</div>
